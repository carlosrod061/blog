...
class BlogPostController extends Controller
{
    ...
    public function update(Request $request,$id)
    {
        ...
        if($blogPost->update()){
            ...
            return redirect()->back()->with('failed','Blog post information could not be updated');
        }
    }
    ...
    public function destroy($id)
    {
        ...
        if(BlogPost::destroy($id)){
            ...
            return redirect()->back()->with('destroy-failed','Blog post information could not be deleted');
        }
    }
}
